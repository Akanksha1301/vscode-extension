...
const basicInput_1 = __webpack_require__(4);
const multiStepInput_1 = __webpack_require__(178);
const quickOpen_1 = __webpack_require__(179);
const SidebarProvider_1 = __webpack_require__(181);
function activate(context) {
    console.log('Congratulations, your extension "firstextension" is now active!');
    const sidebarProvider = new SidebarProvider_1.SidebarProvider(context.extensionUri);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("sidebar", sidebarProvider));
    ...
    //   })
    context.subscriptions.push(vscode.commands.registerCommand('firstextension.Hello', () => __awaiter(this, void 0, void 0, function* () {
        const panel = vscode.window.createWebviewPanel("sample", "Akanksha Jain ", vscode.ViewColumn.One, {});
        // console.log("morning")		
    ...
    context.subscriptions.push(vscode.commands.registerCommand('firstextension.helloWorld', () => __awaiter(this, void 0, void 0, function* () {
        HelloWorldPanel_1.HelloWorldPanel.createOrShow(context.extensionUri);
    })));
    context.subscriptions.push(vscode.commands.registerCommand('firstextension.quickInput', () => __awaiter(this, void 0, void 0, function* () {
        console.log("xyzzz");
        const options = {
...
class HelloWorldPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(HelloWorldPanel.viewType, "Extra File", column || vscode.ViewColumn.One, {
...
HelloWorldPanel.viewType = "Hello :)";
 ...
 */
var Students = [
    { "Name": "Akanksha", "Country": "China" },
    { "Name": "Akash", "Country": "Russia" },
    { "Name": "Mayank", "Country": "Germany" },
    { "Name": "Shreya", "Country": "Japan" },
    { "Name": "Swapnil", "Country": "France" }
];
...
app.get('/student/:name', function (req, res) {
    var result = get_name(req.params.name);
    if (!isEmpty(result)) {
        console.log(result);
...
function showQuickPick() {
    return __awaiter(this, void 0, void 0, function* () {
        let i = 0;
        const result = yield vscode_1.window.showQuickPick(['ADD STUDENT', 'UPDATE', 'DELETE', 'GET DATA'], {
            placeHolder: 'ADD,DELETE,UPDATE,GET DATA',
            onDidSelectItem: item => axios_1.default.get(url + '/student/Akanksha')
                .then(function (response) {
                console.log(response.data);
                vscode_1.window.showInformationMessage(response.data);
            })
...
var res = __webpack_require__(132);
...
exports.static = __webpack_require__(136);
...
var callSiteToString = __webpack_require__(9).callSiteToString
var eventListenerCount = __webpack_require__(9).eventListenerCount
...
var read = __webpack_require__(33)
...
var createError = __webpack_require__(17)
var getBody = __webpack_require__(34)
...
var Router = __webpack_require__(89);
var methods = __webpack_require__(98);
var middleware = __webpack_require__(101);
var query = __webpack_require__(102);
var debug = __webpack_require__(91)('express:application');
var View = __webpack_require__(103);
var http = __webpack_require__(99);
var compileETag = __webpack_require__(105).compileETag;
var compileQueryParser = __webpack_require__(105).compileQueryParser;
var compileTrust = __webpack_require__(105).compileTrust;
...
var encodeUrl = __webpack_require__(85)
var escapeHtml = __webpack_require__(86)
var onFinished = __webpack_require__(61)
...
var debug = __webpack_require__(91)('express:router');
var deprecate = __webpack_require__(8)('express');
var flatten = __webpack_require__(95);
var parseUrl = __webpack_require__(87);
var setPrototypeOf = __webpack_require__(18)
...
var debug = __webpack_require__(91)('express:router:route');
var flatten = __webpack_require__(95);
var Layer = __webpack_require__(96);
var methods = __webpack_require__(98);
...
var debug = __webpack_require__(91)('express:router:layer');
...
var debug = __webpack_require__(91)('express:view');
...
function View(name, options) {
  ...
  if (!opts.engines[this.ext]) {
    ...
    var fn = __webpack_require__(104)(mod).__express
...
var contentDisposition = __webpack_require__(107);
var contentType = __webpack_require__(16);
var deprecate = __webpack_require__(8)('express');
var flatten = __webpack_require__(95);
var mime = __webpack_require__(108).mime;
var etag = __webpack_require__(115);
var proxyaddr = __webpack_require__(122);
var qs = __webpack_require__(72);
...
var createError = __webpack_require__(17)
var debug = __webpack_require__(109)('send')
var deprecate = __webpack_require__(8)('send')
var destroy = __webpack_require__(114)
var encodeUrl = __webpack_require__(85)
var escapeHtml = __webpack_require__(86)
var etag = __webpack_require__(115)
var fresh = __webpack_require__(117)
var fs = __webpack_require__(31)
var mime = __webpack_require__(118)
var ms = __webpack_require__(120)
var onFinished = __webpack_require__(61)
var parseRange = __webpack_require__(121)
var path = __webpack_require__(13)
var statuses = __webpack_require__(19)
...
var Stats = __webpack_require__(31).Stats
...
mime.define(__webpack_require__(119));
...
var forwarded = __webpack_require__(123)
var ipaddr = __webpack_require__(124)
...
var Negotiator = __webpack_require__(127)
var mime = __webpack_require__(66)
...
var escapeHtml = __webpack_require__(86);
var http = __webpack_require__(99);
var isAbsolute = __webpack_require__(105).isAbsolute;
var onFinished = __webpack_require__(61);
var path = __webpack_require__(13);
var statuses = __webpack_require__(19)
var merge = __webpack_require__(100);
var sign = __webpack_require__(133).sign;
var normalizeType = __webpack_require__(105).normalizeType;
var normalizeTypes = __webpack_require__(105).normalizeTypes;
var setCharset = __webpack_require__(105).setCharset;
var cookie = __webpack_require__(134);
var send = __webpack_require__(108);
var extname = path.extname;
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(135);
...
var mergeConfig = __webpack_require__(173);
...
// Expose isAxiosError
axios.isAxiosError = __webpack_require__(177);
...
var buildURL = __webpack_require__(142);
var http = __webpack_require__(99);
var https = __webpack_require__(160);
var httpFollow = __webpack_require__(161).http;
var httpsFollow = __webpack_require__(161).https;
var url = __webpack_require__(88);
var zlib = __webpack_require__(63);
var pkg = __webpack_require__(172);
var createError = __webpack_require__(151);
var enhanceError = __webpack_require__(152);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(164)("follow-redirects");
    }
    catch (error) {
      debug = function () { /* */ };
    }
...
module.exports = __webpack_require__(166)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(167);
...
const tty = __webpack_require__(30);
...
try {
	...
	const supportsColor = __webpack_require__(169);
...
const os = __webpack_require__(170);
const hasFlag = __webpack_require__(171);
...
const cp = __webpack_require__(180);
const vscode_1 = __webpack_require__(1);
const vscode_2 = __webpack_require__(1);
/**
